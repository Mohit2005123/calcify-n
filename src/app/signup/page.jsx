    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-4xl flex flex-col">
            ...
            <form>
              <div className="flex gap-4 mb-4">
                <div className="flex-1">
                  ...
                  <input type="text" id="firstName" name="firstName" className="w-full px-3 py-2 border border-[rgba(102,102,102,0.35)] rounded-md" />
                </div>
                <div className="flex-1">
                  <label htmlFor="lastName" className="block text-sm font-medium text-[#666666] mb-1 font-poppins text-[16px]">Last name</label>
                  <input type="text" id="lastName" name="lastName" className="w-full px-3 py-2 border border-[rgba(102,102,102,0.35)] rounded-md" />
                </div>
              </div>
              ...
              <div className="flex gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <input type="password" id="confirmPassword" name="confirmPassword" className="w-full px-3 py-2 border border-[rgba(102,102,102,0.35)] rounded-md" />
                </div>
              </div>
        ...
        <div className="mt-4 flex flex-col items-center">
          <button type="submit" className="bg-gray-400 text-white py-2 px-4 rounded-full text-base font-semibold hover:bg-gray-500 transition duration-300 w-full max-w-sm">
            Create an account
          </button>
